...
app.get('/websites/:websiteId/sections/:isectionI/git/status/:id', websiteSectionGitController.ensureMyStatus, websiteSectionGitController.websiteSectionGitStatusGet);

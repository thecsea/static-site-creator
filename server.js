...
app.get('/websites/:websiteId/sections/:idSection/git/status/:id/get/:noData', websiteSectionGitController.ensureMyStatus, websiteSectionGitController.websiteSectionGitStatusGet);
